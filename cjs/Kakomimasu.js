...
exports.Player = exports.Kakomimasu = exports.Game = exports.Field = exports.Board = exports.Agent = exports.Action = void 0;
...
class Agent {
    ...
    checkRemove(x, y) {
        ...
        if (this.field.get(x, y)[0] !== Field.WALL)
            return false;
        return true;
    }
    isValidAction() {
            ...
            for (let pid = 0; pid < this.board.nplayer; pid++) {
                ...
                const chk = (x, y) => {
                    ...
                    if (x < 0 || x >= w + 2 || y < 0 || y >= h + 2)
                        ...
                        return;
                    else if (mask[n] !== 0 && field[n][0] === Field.WALL && field[n][1] === pid) {
                        return;
                    }
                    else {
                        area[n] &= ~(1 << pid);
...
class Game {
    ...
    nextTurn() {
        ...
        this.field.fillBase();
        this.log.push(actions.map((ar, idx) => {
            return {
    ...
    checkAgentConflict() {
        ...
        (0, util_js_1.flat)(this.agents).forEach((agent) => {
            if (agent.x === -1)
                return;
    ...
    removeOrNot() {
        const agents = (0, util_js_1.flat)(this.agents);
